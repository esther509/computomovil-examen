...
//--------------------------------------------------------------------------------------------
+ (void)getGames:(void (^)(NSMutableArray<SWObject> *matches)) handler{
    
    NSURLSession *session = [self getSession];
    NSMutableURLRequest * request = [self getRequest:[nURLMatchesAPI stringByAppendingString:@"2017/11/15"] forData:nil];
        ...
        if(data!=nil){
            ...
            if(jsonResponse!=nil){
                ...
                dispatch_async(dispatch_get_main_queue(), ^{
                    ...
                    @try {
                        NSError *err = nil;
                        NSMutableArray<SWObject>  *games = (NSMutableArray<SWObject> *)[SWObject arrayOfModelsFromDictionaries:gameList error:&err];
                        handler(games);
                    }
